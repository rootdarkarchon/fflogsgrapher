...
public static class Program
{
    ...
    private static Dictionary<string, TimeSpan> PhaseActiveEnrageTimes = new()
    {
        ...
        { "P4: Blue Screen", TimeSpan.FromSeconds(60.0) },
        { "P5: Run: Dynamis", TimeSpan.FromSeconds(291.0) },
        { "P1: Fatebreaker", TimeSpan.FromSeconds(165.0) },
        { "P2: Usurper of Frost", TimeSpan.FromSeconds(190.0) },
        { "P3: Oracle of Darkness", TimeSpan.FromSeconds(160.0) },
        { "P4: Enter the Dragon", TimeSpan.FromSeconds(185.0) },
    };
    ...
    private static Dictionary<string, Color> PhaseColors = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "P1: Fatebreaker", ColorTranslator.FromHtml("#ff4285f4") },
        { "P2: Usurper of Frost", ColorTranslator.FromHtml("#ffea4335") },
        { "P3: Oracle of Darkness", ColorTranslator.FromHtml("#fffbbc04") },
        { "P4: Enter the Dragon", ColorTranslator.FromHtml("#ff34a853") },
        { "P5: Pandora", ColorTranslator.FromHtml("#47bdc6") },
    ...
    {
        { "P1: Adelphel, Grinnaux and Charibert", "P1: Adelphel, Grinnaux and Charibert" },
        { "P2: King Thordan", "P2: King Thordan" },
        { "P3: Nidhogg", "P3: Nidhogg" },
        { "P4: The Eyes", "P4: The Eyes" },
        { "Intermission: Rewind!", "I1: Rewind!" },
        { "P5: King Thordan II", "P5: King Thordan II" },
        { "P6: Nidhogg and Hraesvelgr", "P6: Nidhogg and Hraesvelgr" },
        { "P7: The Dragon King", "P7: The Dragon King" },
        { "P1: Living Liquid", "P1: Living Liquid" },
        { "Intermission: Limit Cut", "I1: Limit Cut" },
        { "P2: Brute Justice and Cruise Chaser", "P2: BJCC" },
        { "Intermission: Temporal Stasis", "I2: Temporal Statis" },
        { "P3: Alexander Prime", "P3: Alexander Prime" },
        { "P4: Perfect Alexander", "P4: Perfect Alexander" },
        { "P1: Twintania", "P1: Twintania" },
        { "P2: Nael deus Darnus", "P2: Nael" },
        { "P3: Bahamut Prime", "P3: Bahamut Prime" },
        { "P4: Triple Threat", "P4: Triple Threat" },
        { "P5: Reborn!", "P5: Reborn!" },
        { "Garuda", "P1: Garuda" },
        { "Ifrit", "P2: Ifrit" },
        { "Titan", "P3: Titan" },
        { "Magitek Bits", "I1: Magitek" },
        { "The Ultima Weapon", "P5: The Ultima Weapon" },
        { "P1: Omega", "P1: Omega" },
    ...
    private static Dictionary<string, Color> JobColors = new()
    {
        ...
        { "Astrologian", ColorTranslator.FromHtml("#ffe74a") },
        ...
        { "Viper", ColorTranslator.FromHtml("#108211") },
        { "Pictomancer", ColorTranslator.FromHtml("#fc92e1") },
    };
