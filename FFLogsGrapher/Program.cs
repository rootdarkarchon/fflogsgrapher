...
public static class Program
{
    ...
    private static Dictionary<string, string> PhaseLabels = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "P1: Fatebreaker", "P1: This is Thancred" },
        { "P2: Usurper of Frost", "P2: Usurper of Feet" },
        { "P3: Oracle of Darkness", "P3: Oracle of BJs" },
        { "P4: Enter the Dragon", "P4: Double the Penetration" },
        { "P5: Pandora", "P5: Mostly Exas" },
        { "OOC", "Not in Combat" }
    };
